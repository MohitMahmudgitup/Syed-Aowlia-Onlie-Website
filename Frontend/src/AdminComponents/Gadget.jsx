...
return (
  <div className="max-w-4xl bg-white shadow-lg rounded-2xl p-6">
      ...
      <div>
        ...
        <div className="relative">
          ...
          {showOptions && filteredColors.length > 0 && (
            <div className="absolute mt-1 w-full bg-white border rounded-lg shadow-lg max-h-48 overflow-y-auto z-20">
              {filteredColors.map((color) => (
                <div
                  key={color}
                  className="px-3 py-2 cursor-pointer hover:bg-blue-50 flex items-center capitalize"
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <select name="bestseller" value={formData.bestseller} onChange={handleInputChange} className={InputColors}>
          ...
          <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-4">
            {images.map((img, i) => (
              <div key={i} className="relative">
                <img src={img.preview} alt="Preview" className="w-full h-32 object-cover rounded-lg border" />
