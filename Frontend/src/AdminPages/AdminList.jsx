            ...
            <div className="bg-white p-6 rounded-lg w-96 max-w-[90vw] shadow-lg relative max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="bg-gray-100 overflow-auto max-h-32 p-3 rounded-md">
                ...
                <div className="flex flex-wrap gap-6">
                  <div className="bg-gray-50 px-4 py-2 rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                    ...
                    <p className="text-sm font-medium">{selectedProduct.brand || "N/A"}</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                    <p className="text-xs text-gray-500">Type</p>
                    <p className="text-sm font-medium">{selectedProduct.product_type || "N/A"}</p>
                  </div>
                  {selectedProduct.model && (
                    <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                      <p className="text-xs text-gray-500">Model</p>
                      <p className="text-sm font-medium">{selectedProduct.model}</p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {selectedProduct.bestseller && (
                    <span className="bg-yellow-100 px-3 py-1 rounded-md text-xs font-semibold text-yellow-800">
                      Bestseller
                    </span>
                  )}
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      {selectedProduct.sizes.map((size, index) => (
                        <span key={index} className="bg-gray-200 px-3 py-1 rounded text-xs">
                          {size}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {selectedProduct.ram && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        ...
                        <p className="text-sm font-medium">{selectedProduct.ram} GB</p>
                      </div>
                    )}
                    {selectedProduct.rom && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">ROM</p>
                        <p className="text-sm font-medium">{selectedProduct.rom} GB</p>
                      </div>
                    )}
                    {selectedProduct.storage && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">Storage</p>
                        <p className="text-sm font-medium">{selectedProduct.storage} GB</p>
                      </div>
                    )}
                    {selectedProduct.processor && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">Processor</p>
                        <p className="text-sm font-medium">{selectedProduct.processor}</p>
                      </div>
                    )}
                    {selectedProduct.display && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">Display</p>
                        <p className="text-sm font-medium">{selectedProduct.display}</p>
                      </div>
                    )}
                    {selectedProduct.battery && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">Battery</p>
                        <p className="text-sm font-medium">{selectedProduct.battery} mAh</p>
                      </div>
                    )}
                    {selectedProduct.os && (
                      <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                        <p className="text-xs text-gray-500">OS</p>
                        <p className="text-sm font-medium">{selectedProduct.os}</p>
                      </div>
                    )}
                  </div>
                </div>
