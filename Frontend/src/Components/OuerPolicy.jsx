  ...
  return (
    <div className="my-16 mx-auto max-w-screen-xl px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-8 pt-8">
        ...
        <div className={`flex flex-col items-center ${darkmode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} shadow-md rounded-lg p-6 transition-transform duration-300 hover:shadow-lg hover:scale-105`}>
          ...
          <p className={`text-center text-sm ${darkmode ? 'text-gray-300' : 'text-gray-500'}`}>We offer hassle-free exchange policy.</p>
        </div>
        ...
        <div className={`flex flex-col items-center ${darkmode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} shadow-md rounded-lg p-6 transition-transform duration-300 hover:shadow-lg hover:scale-105`}>
          ...
          <p className={`text-center text-sm ${darkmode ? 'text-gray-300' : 'text-gray-500'}`}>We provide a 7 days free return policy.</p>
        </div>
        ...
        <div className={`flex flex-col items-center ${darkmode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} shadow-md rounded-lg p-6 transition-transform duration-300 hover:shadow-lg hover:scale-105`}>
          ...
          <p className={`text-center text-sm ${darkmode ? 'text-gray-300' : 'text-gray-500'}`}>We provide 24/7 customer support.</p>
        </div>
      </div>
    </div>
  );
