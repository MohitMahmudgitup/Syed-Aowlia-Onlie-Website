    ...
    <div className="flex justify-center items-center h-screen -mt-16 ">
      {isSubmitted || token ? (
        <div className="text-center p-8 ">
          <h2 className="text-3xl font-bold mb-4 text-green-500">Account Created Successfully!</h2>
          {/* <p className="text-gray-700 mb-6">Welcome, {username}! Your account has been created.</p> */}
          <div className='flex items-center justify-center'>
            <img className='w-40' src="https://m.media-amazon.com/images/I/715vwvP5ZEL._h1_.png" alt="" />
        ...
        <div className="w-full max-w-md bg-white p-8 ">
          <div className="flex justify-center">
            {signUpsignIn ? (
              ...
              <Titel text2={`Login`} color2={"text-3xl font-bold text-center mb-6 prata-regular"} />
            )}
          </div>
