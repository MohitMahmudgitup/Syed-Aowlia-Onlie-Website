  ...
  return (
    <div className='my-10'>
      <div className='text-center text-3xl py-8'>
        ...
        <p className={`w-3/4 text-xs sm:text-sm m-auto md:text-base ${darkmode ? 'text-gray-300' : 'text-gray-600'}`}> Explore ecommerce, from how it works to types of ecommerce models to online shopping trends to the benefits of selling online.</p>
