...
const Contact = () => {
  ...
  return (
    <div
      className={`py-12 ${darkmode ? " text-white" : "bg-white text-gray-800"}`}
    >
      <div className="container mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            className={`p-8 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-xl 
            ${
              darkmode
        ...
        <div className="mt-8">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full hbgbtn text-white py-2 rounded  "
            >
              Send Message
            </button>
          </form>
